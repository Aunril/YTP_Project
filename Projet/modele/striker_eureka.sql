...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 10 juil. 2019 à 14:43
...
CREATE TABLE IF NOT EXISTS `produits_commande` (
  ...
  `envoye` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `produits_commande` (`id_produit_commande`, `id_commande`, `id_produit`, `quantite`, `envoye`) VALUES
(1, 1, 4, 1, 0),
(2, 1, 8, 1, 0),
(3, 2, 2, 1, 0),
(4, 2, 12, 1, 0);
